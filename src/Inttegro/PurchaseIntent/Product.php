...
/**
 * Product details associated with purchase intent.
 *
...
final class Product extends \Inttegro\DomainValue
{
     ...
     * `list<\Inttegro\PurchaseIntent\ProductAttributesItem>|null`; wire field: `attributes`
     * (`array<object>`).
     * When the field is absent, the SDK exposes an empty collection.
     *
     * @var list<\Inttegro\PurchaseIntent\ProductAttributesItem>|null
     */
    ...
    /**
     * Identifier of the related variant set.
     *
     * Optional response field. PHP type: `string|null`; wire field: `variant_set_id` (`string`).
     *
     * @var string|null
     */
    ...
    public function __construct(array $data)
    {
        ...
        $this->attributes = \Inttegro\ValueHydrator::objects($data['attributes'] ?? null, [\Inttegro\PurchaseIntent\ProductAttributesItem::class]);
        ...
        $this->variantSetId = \Inttegro\ValueHydrator::string($data['variant_set_id'] ?? null, true);
    }
